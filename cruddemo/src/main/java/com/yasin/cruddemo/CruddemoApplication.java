package com.yasin.cruddemo;

import com.yasin.cruddemo.dao.StudentDAO;
...
public class CruddemoApplication {
	...
	private void readStudent(StudentDAO studentDAO) {
		...
		//display student
		System.out.println("Foun the student: " + myStudent);
	}

	private void createMultipleStudents(StudentDAO studentDAO) {
		//create mutliple studens
		System.out.println("Creating new student object ...");
	...
	private void createStudent(StudentDAO studentDAO) {
		...
		// display id of the saved student
		System.out.println("Student has saved. Generated id: " + tempStudent.getId());
	}
}
